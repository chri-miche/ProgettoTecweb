...
% TODO
    \subsection{Database}
% TODO Jacopo
    Il funzionamento della piattaforma si basa sul database rappresentato in figura.
    Alla base dalla struttura troviamo le tabelle Tag, Utente e Contenuto.
    \paragraph{Tag} La tabella Tag viene sfruttata per rappresentare un qualsiasi elemento che rappresenta un oggetto nel sito,
                    quindi per tutti i contenuti correlati alle specie del catalogo, divise in: \emph{Genere, Famiglia, Ordine}.
    \paragraph{Utente} Rappresenta uno user iscritto al sito che è in stretta correlazione con i Contenuti da lui pubblicati.
                        Inoltre ogni utente può essere riferito o riferire altri utenti dalla tabella \emph{seguito}
                        che rappresenta la sottoscrizione di un utente alle attività dell'altro.
    \paragraph{Contenuto} Rappresenta il contenuto rappresentabile creato da un \emph{Utente} e si distingue in
...
%TODO miche AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
