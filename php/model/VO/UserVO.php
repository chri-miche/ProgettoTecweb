<?php
    ...
    class UserVO implements VO {
        ...
        public function __construct(int $id = null, string $nome = null, string $email = null, string $password = null,
                                    string $immagine = 'immagine.jpg', bool $admin = false) {
        ...
        /*** @param bool $admin
         * @return UserVO */
        public function setAdmin(bool $admin): UserVO{
            if(!$this->moderator) $this->moderator = true;
            $this->admin = $admin; return $this;
        }

        /** @param string $nome
         * @return UserVO */
        public function setNome(string $nome): UserVO {
            $this->nome = $nome; return $this;
        }

        /*** @param string $email
         * @return UserVO */
        public function setEmail(string $email): UserVO {
            $this->email = $email; return $this;
        }

        /** @param string $password
         * @return UserVO */
        public function setPassword(string $password): UserVO{
            $this->password = $password; return $this;
        }

        /*** @param string $immagine
         * @return UserVO */
        public function setImmagine(string $immagine): UserVO{
            $this->immagine = $immagine; return $this;
        }
